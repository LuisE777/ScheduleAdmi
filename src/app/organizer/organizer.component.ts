...
// SOCIOLOGIA ORGANIZACIONAL (1301012)
{
  ...
  docentes: [
...

    {
      nombre: 'TERCER SEMESTRE',
      materias: [
        // SISTEMAS ADMINISTRATIVOS (1301013)
{
  nombre: 'SISTEMAS ADMINISTRATIVOS',
  docentes: [
    {
...
// ECONOMIA DE EMPRESAS II (1301014)
{
  nombre: 'ECONOMIA DE EMPRESAS II',
  docentes: [
    {
...
// TEORIA DE COSTOS (1301015)
{
  ...
  docentes: [
    ...
    },
    {
      ...
      group: '23',
      days: [
        { day: 'Miércoles', start: '14:15', end: '15:45', classRoom: 'E 206' },
        { day: 'Jueves', start: '14:15', end: '15:45', classRoom: 'E 206' },
        { day: 'Viernes', start: '14:15', end: '15:45', classRoom: 'E 206' }
      ]
    }
  ]
},

// ESTADISTICA II (1301016)
{
  nombre: 'ESTADISTICA II',
  docentes: [
    {
    ...
    },
    {
      ...
      days: [
        { day: 'Martes', start: '15:45', end: '17:15', classRoom: 'E 105', auxiliary: true },
        { day: 'Miércoles', start: '18:45', end: '20:15', classRoom: 'E 404' },
        { day: 'Jueves', start: '18:45', end: '20:15', classRoom: 'E 404' }
      ]
    },
    {
      id: 76,
...
// MACROECONOMIA (1301017)
{
  ...
  docentes: [
...

    {
      nombre: 'CUARTO SEMESTRE',
      materias: [
        // PROCEDIMIENTOS ADMINISTRATIVOS (1301018)
{
  nombre: 'PROCEDIMIENTOS ADMINISTRATIVOS',
  docentes: [
    {
  ...
  docentes: [
    ...
    },
    {
      ...
      days: [
        { day: 'Lunes', start: '06:45', end: '08:15', classRoom: 'E545' },
        { day: 'Miércoles', start: '06:45', end: '08:15', classRoom: 'E 102' },
        { day: 'Jueves', start: '17:15', end: '18:45', classRoom: 'E 109' }
      ]
    },
    {
      id: 94,
...
// INFORMATICA I (1301020)
{
  nombre: 'INFORMATICA I',
  docentes: [
    {
      id: 95,
      name: 'MONTANO QUIROGA VICTOR HUGO',
      group: '01',
      days: [
        { day: 'Lunes', start: '08:15', end: '09:45', classRoom: 'E 401' },
        { day: 'Martes', start: '08:15', end: '09:45', classRoom: 'E 406' },
    ...
    {
      id: 96,
      name: 'VELARDE POMA JUAN CARLOS',
      group: '02',
      days: [
        { day: 'Miércoles', start: '06:45', end: '08:15', classRoom: 'E548' },
        { day: 'Jueves', start: '06:45', end: '08:15', classRoom: 'E548' },
        { day: 'Viernes', start: '06:45', end: '08:15', classRoom: 'E548' }
      ]
    },
    {
      id: 97,
      name: 'SANDOVAL ARNEZ JUAN ALBERTO',
      group: '20',
      days: [
        { day: 'Lunes', start: '20:15', end: '21:45', classRoom: 'E547' },
        { day: 'Jueves', start: '06:45', end: '08:15', classRoom: 'E547' },
    ...
    },
    {
      ...
      group: '21',
      days: [
        { day: 'Martes', start: '12:45', end: '14:15', classRoom: 'E547' },
        { day: 'Miércoles', start: '12:45', end: '14:15', classRoom: 'E 402' },
        { day: 'Jueves', start: '12:45', end: '14:15', classRoom: 'E 402' }
      ]
    },
    ...
    {
      id: 100,
      name: 'JORDAN SANCHEZ JUAN CARLOS',
      group: '23',
      days: [
        { day: 'Lunes', start: '20:15', end: '21:45', classRoom: 'E 407' },
        { day: 'Jueves', start: '20:15', end: '21:45', classRoom: 'E 402' },
...
// COSTOS PARA LA TOMA DE DECISIONES (1301021)
{
  nombre: 'COSTOS PARA LA TOMA DE DECISIONES',
  docentes: [
    {
      id: 101,
      name: 'RIVERA MICHEL HENRY',
      group: '01',
      days: [
        { day: 'Miércoles', start: '12:45', end: '14:15', classRoom: 'E PB-2' },
        { day: 'Jueves', start: '12:45', end: '14:15', classRoom: 'E PB-2' },
    ...
    {
      id: 102,
      name: 'CHOQUEPALPA RIOZ ORLANDO DANIEL',
      group: '02',
      days: [
        { day: 'Jueves', start: '08:15', end: '09:45', classRoom: 'E504' },
        { day: 'Viernes', start: '08:15', end: '09:45', classRoom: 'E 109' },
    ...
    },
    {
      ...
      days: [
        { day: 'Lunes', start: '15:45', end: '17:15', classRoom: 'E503', auxiliary: true },
        { day: 'Miércoles', start: '18:45', end: '20:15', classRoom: 'E544' },
        { day: 'Jueves', start: '18:45', end: '20:15', classRoom: 'E511' }
      ]
    },
    {
      id: 104,
    ...
    },
    {
      ...
      group: '21',
      days: [
        { day: 'Jueves', start: '06:45', end: '08:15', classRoom: 'E 109' },
        { day: 'Viernes', start: '06:45', end: '08:15', classRoom: 'E502' },
        { day: 'Viernes', start: '17:15', end: '18:45', classRoom: 'E 203', auxiliary: true }
      ]
    },
    {
...
// ANALISIS DE ESTADOS FINANCIEROS (1301022)
{
  nombre: 'ANALISIS DE ESTADOS FINANCIEROS',
  docentes: [
    {
      id: 107,
      name: 'PRADEL SERRANO RUTH ISABEL',
      group: '01',
      days: [
        { day: 'Lunes', start: '18:45', end: '20:15', classRoom: 'E520' },
        { day: 'Martes', start: '18:45', end: '20:15', classRoom: 'E521' },
